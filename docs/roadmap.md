...
1. [General refinement CFG fixed points](https://github.com/mizchi/uneffect/issues/23)
   ...
   Completed bounded child [#47](https://github.com/mizchi/uneffect/issues/47)
   ...
   Completed child [#48](https://github.com/mizchi/uneffect/issues/48) composes that
...
direct Promise-call returns, with one optional `as Promise<T>` wrapper. Active child
