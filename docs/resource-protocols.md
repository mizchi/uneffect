...
unconditional whole-function proof. This IR currently validates the composition
ledger and resource lifecycle. Executable interleaving is still generated by
the dedicated bounded using/host Quint model. Replacing that generator with the
common product backend, conditional acquisition, fairness, and arbitrary
callback interleavings remain future work.
