...
| ---: | --- | --- | ---: | --- | --- |
| 1 | #25 general CFG values | L | 3–8 weeks | Continue beyond completed bounded child #39 | Value conflict, widening, recurrence, and irreducible control |
...
- **Next implementable result:** not selected. Split one bounded child from #25,
  or select #2/#5 versus #4/#6 from application evidence before activating it.
