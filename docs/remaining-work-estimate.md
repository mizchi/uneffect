...
| 4 | #5 collection temporal state/TLC | L | 3–6 weeks | Select the next bounded child after completed #42/#43/#44 | Collection semantics, mutually dependent key invariants, wider finite universes, and external trace interoperability |
...
- **Next implementable result:** none is promoted. Choose a bounded child from
  #25/#2/#5/#4/#6 only after application evidence defines a Red test and a
