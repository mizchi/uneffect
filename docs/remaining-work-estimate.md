...
#39 is the active bounded child of #25. Its 1–2 week estimate is included in
...
| P2.24 conditional predecessor value | #39 (child of #25) | Active after #38 | 1–2 weeks | Lower one loop-local conditional value into source-bound predecessor evidence independently of statement-shaped joins. |
...
| ---: | --- | --- | ---: | --- | --- |
| 1 | #39 conditional predecessor value (included in #25) | M | 1–2 weeks | Verify one source-bound loop-local conditional value join | Source correlation, unused values, and nested/multiple joins |
| 2 | #25 general CFG values | L | 3–8 weeks | Continue beyond bounded child #39 | Value conflict, widening, recurrence, and irreducible control |
...
| Current slice | #39 conditional predecessor value | 1–2 engineer-weeks | Lower one Boolean conditional expression into generic source-bound predecessor evidence and independently prove the recurrence. |
...
- **Next implementable result:** #39, estimated at 1–2 engineer-weeks and
  included in #25.
