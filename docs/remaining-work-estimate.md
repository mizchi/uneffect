...
| 2 — Specification expressiveness | #48 (inside #25), #25, #2, #5, #4, #6 | 19–39 engineer-weeks | Low–medium |
...
#48 is the active 1–2 engineer-week child of #25 and is already contained in
the parent's unchanged 3–8 week range. It extends #47 through one exact
catch/finally handler topology and is not added to the total.
...
| ---: | --- | --- | ---: | --- | --- |
| 1 | #48 caught retry backoff (child of #25) | M | 1–2 weeks | Complete handler-bound activation evidence, benchmark, and CI handoff | Keeping path selection immutable, source-bound, and tamper-resistant |
| 2 | #25 general CFG values | L | 3–8 weeks inclusive of #48 | Complete #48, then select the next application-backed bounded child | Value conflict, widening, recurrence, and irreducible control |
...
| Active slice | #48 caught retry backoff | 1–2 engineer-weeks, included in #25 | Compose one immutable failure selector and catch/finally provenance with #47's finite proof rule. |
...
- **Next implementable result:** finish #48's caught-path retry handoff without
  widening it into dynamic or general path-dependent exponentiation.
