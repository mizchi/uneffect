...
#38 is the active bounded child of #25. Its 1–2 week estimate is included in
the remaining #25 epic range and is not added again to the total.
...
| P2.23 upper-triangular affine recurrence | #38 (child of #25) | Active after #37 | 1–2 weeks | Prove one source-ordered constant-delta driver and one affine dependent before one ranking back edge. |
...
| ---: | --- | --- | ---: | --- | --- |
| 1 | #38 upper-triangular affine recurrence (included in #25) | M | 1–2 weeks | Verify one driver/dependent arithmetic-series summary with source-order evidence | Sequential update identity, canonical closed form, and induction obligations |
| 2 | #25 general CFG values | L | 3–8 weeks | Continue beyond bounded child #38 | Value conflict, widening, recurrence, and irreducible control |
...
| Current slice | #38 upper-triangular affine recurrence | 1–2 engineer-weeks | Preserve one source-ordered driver/dependent edge and independently prove its closed form. |
...
- **Next implementable result:** #38, estimated at 1–2 engineer-weeks and
  included in #25.
