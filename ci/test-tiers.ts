export const ciTestTiers = {
  fast: [
    ...
    "test/annotation-registry.test.ts",
    ...
    "test/compiler-diagnostics.test.ts",
    ...
    "test/corsa-fact-consumer.test.ts",
    ...
    "test/module-order-corsa.test.ts",
    ...
    "test/cfg-lint.test.ts",
    "test/cfg-lint-typescript.test.ts",
    "test/cfg-lint-cli.test.ts",
    "test/cfg-lint-corsa.test.ts",
    "test/spec-compiler-free.test.ts",
    "test/graph-analysis.test.ts",
    "test/graph-api.test.ts",
    "test/workflow-parallel.test.ts",
    ...
    "test/corsa-workspace-summaries.test.ts",
  ...
  integration: [
    ...
    "test/corsa-source-facts.test.ts",
    "test/corsa-higher-order.test.ts",
    "test/corsa-dom-inheritance.test.ts",
    "test/corsa-class-dispatch.test.ts",
    "test/corsa-browser-contracts.test.ts",
    "test/corsa-dispatch-soundness.test.ts",
    "test/corsa-standard-globals.test.ts",
    "test/corsa-checker-exporter.test.ts",
    "test/corsa-builtin-calls.test.ts",
