...
/* uneffect:temporal state authority: { owners: Set<int>, epochs: Map<int, int> } */ /* uneffect:temporal init authority = { owners: Set(1), epochs: Map([[1, 0]]) } */ /* uneffect:temporal action admitOwner: authority' = { ...authority, owners: authority.owners.union(Set(2)) } */ /* uneffect:temporal action publishEpoch: authority' = { ...authority, epochs: authority.epochs.put(2, 1) } */ /* uneffect:temporal action revokeOwners: authority' = { ...authority, owners: Set() } */ /* uneffect:temporal action clearEpochs: authority' = { ...authority, epochs: Map([]) } */ /* uneffect:temporal action revokeOwner: authority' = { ...authority, owners: authority.owners.exclude(Set(1)) } */ /* uneffect:temporal action retireEpoch: authority' = { ...authority, epochs: authority.epochs.remove(1) } */ /* uneffect:temporal action revokeImportedOwner: authority' = { ...authority, owners: authority.owners.exclude(Set(1)) } */ /* uneffect:temporal action revokeNamespacedOwner: authority' = { ...authority, owners: authority.owners.exclude(Set(1)) } */
