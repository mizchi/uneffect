...
import { validateOwnershipEvidence, type OwnershipEvidenceArtifact } from "../evidence/evidence.js";
import type { OwnershipGuardObligation } from "../async/async-safety.js";
