...
import { formatEffect, unresolvedCapabilityReasons } from "../effects/capabilities.js";
...
export function assessCheckAssurance(
  result: Pick<CheckResult, "artifacts" | "summaries"> & Partial<Pick<CheckResult, "sources" | "diagnostics" | "project" | "typedArrays" | "ownership" | "asyncIterators" | "resourceProtocols" | "corsaBuiltinCalls">> & { assumptions?: AssumptionLedger },
  profile: AssuranceProfile,
): AssuranceAssessment {
