...
import { interpretBuiltinCallSemantics, projectedArrayElements } from "../effects/builtin-semantic-interpreter.js";
import { resolveStableRegion } from "../effects/region-alias.js";
import { evaluateResourceProtocol, evaluateResourceProtocolCfg, resourceProtocolSchema, type ResourceProtocolModel, type ResourceProtocolState, type ResourceProtocolTransition } from "../resources/resource-protocol.js";
import { resolveBuiltinTypedArrayWindowMethod } from "./typed-array-windows.js";
import { lowerResourceProtocolCfgInFunction, type ResourceTransitionSite } from "../resources/resource-protocol-typescript.js";
import { collectCallableExceptionalTransitionSites } from "../resources/resource-protocol-typescript.js";
import type { ExternalFunctionEffectContract } from "../effects/effects.js";
import type { CallableSummary } from "../effects/callable-summary.js";
