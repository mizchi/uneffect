...
import { checkFiles, createCheckProgram } from "../project/check.js";
...
import { formatCheckEvidence, formatDiagnostics } from "../support/diagnostics.js";
import { assessCheckAssurance, formatAssuranceAssessment, type AssuranceProfile } from "../evidence/assurance.js";
import { loadBuiltinRegistryConfig } from "../effects/registry-config.js";
import { loadUneffectModules } from "../modules/modules.js";
import { loadTypeScriptProject, loadTypeScriptWorkspace } from "../frontends/typescript/typescript-project.js";
import { createCheckJsonReport, createCheckWorkspaceJsonReport } from "./check-report.js";
import { composeWorkspaceEffects, inspectDeclarationOutputs, type CompletedEffectProject, type WorkspaceEffectComposition } from "../project/workspace-effects.js";
import { analyzeProjectRefinements, composeWorkspaceRefinements, type CompletedRefinementProject, type WorkspaceRefinementComposition } from "../project/workspace-refinements.js";
import { inspectBuildOutputs, mergeBuildOutputIntegrity, type BuildOutputIntegrity } from "../project/build-output-integrity.js";
import { loadDeclarationTransformManifest, validateDeclarationTransformManifest } from "../frontends/typescript/declaration-transforms.js";
import { loadAssumptionRegistry } from "../evidence/assumption-registry.js";
import { loadContractSummaryBundle } from "../contracts/contract-summary.js";
import { loadResourceCallableContractArtifact } from "../resources/resource-callable-artifact.js";
import { openCorsaApiFrontend } from "../frontends/corsa/corsa-api-frontend.js";
import {
