...
import { analyzeProgramEffects, type EffectSummary, type ExternalFunctionEffectContract, type ExternalModuleEffectContract } from "../effects/effects.js";
import { analyzeReactProgram } from "../analysis/react-semantics.js";
import type { BuiltinContractRegistry } from "../effects/builtin-contracts.js";
import type { TypeScriptProjectProvenance } from "../frontends/typescript/typescript-project.js";
import { collectAssumptionLedger, mergeAssumptionLedger, type AssumptionEntry, type AssumptionLedger } from "../evidence/assumptions.js";
import { analyzeTrustedScriptSinks } from "../analysis/trusted-types.js";
import type { AssumptionRegistry } from "../evidence/assumption-registry.js";
import { verifyTypedArraySafetyInTypeScriptProgram, type TypedArrayProgramSafetyResult } from "../analysis/typed-array-safety.js";
