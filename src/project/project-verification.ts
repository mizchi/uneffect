...
import { attachContractEffectBoundaries, reconcileContractArtifacts, verifyContractObligations, type ContractDiagnostic, type VerificationArtifact } from "../contracts/contracts.js";
import { bindContractSummaryBundleToProgram, boundContractSummaryEffectContracts, boundContractSummaryResourceContracts, type ContractSummaryBundleV1 } from "../contracts/contract-summary.js";
import { instrumentRuntimeAssertions, type InstrumentDiagnostic } from "../optimizer/instrument.js";
import { analyzeOwnership, type OwnershipDiagnostic } from "../analysis/ownership.js";
import { analyzeCallableSummaries } from "../effects/callable-summary.js";
import { verifyTypedArraySafetyInProgram, type TypedArrayDiagnostic, type TypedArrayProgramSafetyResult } from "../analysis/typed-array-safety.js";
import { resolveRegionIdentity } from "../effects/region-alias.js";
import { collectAssumptionLedger, mergeAssumptionLedger, type AssumptionEntry, type AssumptionLedger, type AssumptionPolicy, type AssumptionPolicyDiagnostic } from "../evidence/assumptions.js";
import { generateTemporalModelFromAsyncSafety } from "../spec/temporal-model.js";
import { analyzeAsyncSafety, type AsyncSafetyDiagnostic } from "../async/async-safety.js";
import { resolveTemporalDslLink } from "../spec/temporal-dsl.js";
import { prepareCapabilityDslLinks } from "../effects/capability-dsl.js";
import { prepareContractDslLinks } from "../contracts/contract-dsl.js";
import { extractLocatedAnnotations } from "../support/annotations.js";
import { resolveRefinementDslLink } from "../refinement/refinement-dsl.js";
import type { RefinementBindingManifest } from "../refinement/refinement-bindings.js";
import { hasProjectCallableAliasContracts, instrumentContractPredicates, relocateProjectCallableAliasContracts } from "../contracts/contract-runtime.js";
import { analyzeProgramEffects, type EffectAnalysisResult, type EffectDiagnostic, type ExternalFunctionEffectContract, type ExternalModuleEffectContract } from "../effects/effects.js";
import { fromTypeScriptDiagnostic, type AsyncIteratorCheckerDiagnostic, type ResourceCheckerDiagnostic, type TypeScriptCheckerDiagnostic } from "../support/diagnostics.js";
import { collectIteratorChecks, type IteratorCheckEvidence } from "../effects/iterator-check.js";
import { analyzeResourceCallableSummaries, analyzeResourceLifecyclesInSource, type ResourceLifecycleEvidence } from "../resources/resource-callable-typescript.js";
...
import type { BuiltinContractRegistry } from "../effects/builtin-contracts.js";
import type { AssumptionRegistry } from "../evidence/assumption-registry.js";
import { analyzeModuleInitializationOrder, type ModuleInitializationOrder } from "../modules/module-initialization.js";
import { loadTypeScriptWorkspace, type TypeScriptProject, type TypeScriptProjectProvenance, type TypeScriptWorkspaceBlocker } from "../frontends/typescript/typescript-project.js";
...
function inMemoryProgram(
  ...
  const selfSpecEntry = [join(moduleDirectory, "../spec/index.ts"), join(moduleDirectory, "../spec/index.d.ts")]
    .find((candidate) => ts.sys.fileExists(candidate));
  ...
  host.resolveModuleNames = (moduleNames, containingFile) => moduleNames.map((moduleName) => {
    ...
    // `src/runtime/numeric.ts` can shadow this package's own `src/runtime/numeric.ts` while
