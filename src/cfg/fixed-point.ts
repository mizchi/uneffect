...
import type { BasicBlock, BasicBlockFixedPointOptions, BasicBlockFixedPointResult } from "./contracts.js";
...
export function solveBasicBlockFixedPoint<Value, Completion extends string = CompletionKind>(
  options: BasicBlockFixedPointOptions<Value, Completion>,
  ...
  const blocks = new Map<string, BasicBlock<Value, Completion>>();
