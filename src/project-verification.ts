...
async function verifyUneffectWorkspace(options: VerifyUneffectWorkspaceOptions): Promise<VerifyUneffectWorkspaceResult> {
  ...
  const assurance: ProjectWorkspaceAssurance = {
    ...
    exclusions: [
      ...
      "cross-project refinement composition is limited to scalar direct calls or one unguarded write-screened local helper; guarded actions require a sole direct wrapper and exact declarations",
