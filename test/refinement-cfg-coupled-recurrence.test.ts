...
/* uneffect: refinement cfgCoupledFlush@1 create */ export function create(initial: Runtime) { return initial }
/* uneffect: refinement cfgCoupledFlush@1 observe */ export function observe(runtime: Runtime) { return runtime }
/* uneffect: refinement cfgCoupledFlush@1 action flush */
