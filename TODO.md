...
- [x] Resolve write-screened JSX event and callback-ref functions through TypeScript named aliases, barrels, and namespace imports, using the declaration module's effect and acquire/release contracts while preserving mutable/dynamic references as explicit unknowns.
...
- [x] Resolve write-screened Effect and reviewed render-Hook callbacks through TypeScript named aliases, barrels, and namespace imports, preserving definition-module effects, cleanup/resource identity, custom-Hook composition, render-purity diagnostics, and replay.
