...
The next Red/Green slice is conditional or abrupt `finally` completion override
with explicit predecessor ownership. Cross/nested catch-side labels, dynamic
