...
- [x] Load consumer compiler options and root-file selection through `check --project <tsconfig.json>` instead of silently applying Uneffect defaults; reject malformed and empty projects.
  ...
  - [ ] Support solution-style project references as separate compiler-option domains and carry the participating config/version set into project-wide verification. ([#20](https://github.com/mizchi/uneffect/issues/20))
