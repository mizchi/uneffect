...
- [x] Load consumer compiler options and root-file selection through `check --project <tsconfig.json>` instead of silently applying Uneffect defaults; reject malformed and empty projects.
  - [ ] Support solution-style project references as separate compiler-option domains and make consumer/analyzer TypeScript version parity machine-readable. ([#20](https://github.com/mizchi/uneffect/issues/20))
