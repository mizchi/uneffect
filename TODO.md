...
- [ ] Load caller-owned registry extensions from a versioned CLI configuration schema; the current extension API is programmatic only. ([#19](https://github.com/mizchi/uneffect/issues/19))
