...
- [x] Fail closed on unreviewed static external module initialization; classify versioned reviewed module-initialization contracts as `trusted`, propagate that evidence through the local import closure, and record every use in the assumption ledger.
